...
void parse_cmdline (int argc, char **argv, int game_index)
{
	...
	*/
	...
	nvdir      = "/storage/savefiles/mame2000/nvram";
	hidir      = "/storage/savefiles/mame2000/hi";
	cfgdir     =  "/storage/savefiles/mame2000/cfg";
	screenshotdir =  "/storage/savefiles/mame2000/snap";
	memcarddir =  "/storage/savefiles/mame2000/memcard";
	stadir     =  "/storage/savefiles/mame2000/sta";
	artworkdir =  "/storage/savefiles/mame2000/artwork";
	cheatdir =  "/storage/savefiles/mame2000/cheat";
